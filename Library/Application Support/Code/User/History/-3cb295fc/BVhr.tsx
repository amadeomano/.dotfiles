...
import { type OrgChartView } from '@personio-web/employees-organizations-view-org-chart-types';
  ...
  return (
    <div className={styles.container}>
      ...
      <PageHierarchical.Root
        ...
        onPanelOpenChange={(open) => !open && closePanel()}
      >
        ...
        <PageHierarchical.Panel>
          ...
          {orgUnitDetailsDrawer.isOpen && (
            <orgUnitDetailsDrawer.Drawer
              ...
              action={orgUnitDetailsDrawer.data?.action}
            />
          )}
        </PageHierarchical.Panel>
      </PageHierarchical.Root>
