...
const contentSecurityPolicy = `
  ...
  frame-src 'self' blob: data: ${trustedDefaultDomains};
  object-src 'self' blob: data: ${trustedDefaultDomains};
  img-src * data:;
  connect-src
  'self'
  ${trustedDefaultDomains}
...
const cspHeaderAuth0 = {
  ...
  value: cspHeader.value.replace(
    "frame-ancestors 'none';",
    'frame-ancestors https://login.personio.de https://login.personio.com https://login.personio-internal.de https://login.personio-internal.com;',
  ),
};
...
const xFrameSecurityHeaderAuth0 = {
  key: 'X-Frame-Options',
  value: 'ALLOW-FROM https://login.personio.com',
};
