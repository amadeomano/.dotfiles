// Note: During the development phase, but the development environment will use a 'production' build
...
<<<<<<< HEAD
  ...
  https://stage-employee-documents-service-raw-upload-bucket.s3.eu-central-1.amazonaws.com
  https://prod-employee-documents-service-raw-upload-bucket.s3.eu-central-1.amazonaws.com
  https://personio-qa-dm-clientdocuments.s3.amazonaws.com
  https://personio-qa-dm-clientdocuments.s3.eu-central-1.amazonaws.com
  https://personio-dev-clientdocuments.s3.amazonaws.com
  https://personio-dev-clientdocuments.s3.eu-central-1.amazonaws.com
  https://personio-prod-clientdocuments.s3.amazonaws.com
  https://personio-prod-clientdocuments.s3.eu-central-1.amazonaws.com
  https://*.personio.de
  https://*.fullview.io
  wss://*.fullview.io
  https://*.fullview.services
...
=======
  ...
  object-src 'self' blob: ${trustedDefaultDomains};
  img-src * data:;
  connect-src
  'self'
  ${trustedDefaultDomains}
  ${trustedConnectDomains};
>>>>>>> 9f6704a6558 (feat: separate the frame-src and object-src from default-src so that they are only directives that allow blob)
  worker-src
  'self'
  blob:
  data:
  ${IS_DEV_BUILD ? `http://localhost:*` : ''};
`;

const cspHeader = {
  key: 'Content-Security-Policy',
  value: contentSecurityPolicy.replace(/[\s\n]+/g, ' ').trim(),
};
const cspHeaderSelf = {
  ...cspHeader,
