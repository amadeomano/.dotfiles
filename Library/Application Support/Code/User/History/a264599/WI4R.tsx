...
describe('OrgUnitCustomize', () => {
  ...
  const { t: tCustomisation } = getTranslation('employees-organizations', {
  ...
  describe('CustomizeMenu component', () => {
    it('renders all customisation options except disabled ones', async () => {
      ...
      expect(
        screen.getByText(tCustomisation('description')),
      ).toBeInTheDocument();
      expect(
        screen.queryByText(tCustomisation('layer')),
      ).not.toBeInTheDocument();
      expect(screen.getByText(tCustomisation('code'))).toBeInTheDocument();
      expect(
        screen.queryByText(tCustomisation('leads')),
      ).not.toBeInTheDocument();
      expect(
        screen.getByText(tCustomisation('total-members')),
      ).toBeInTheDocument();
      expect(
        screen.queryByText(tCustomisation('open-positions')),
      ).not.toBeInTheDocument();
    });
    ...
    it('renders leads customisation when feature flag is enabled', async () => {
      ...
      await expect(
        screen.findByText(tCustomisation('leads')),
      ).resolves.toBeInTheDocument();
