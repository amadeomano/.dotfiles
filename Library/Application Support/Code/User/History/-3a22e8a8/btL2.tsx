...
import { REPORT_ID as DEF_REC } from '../useDifferencesRecReport';
...
export const ReportModal = () => {
  ...
  const allReports = {
    'gross-to-net': useGrossToNetReportModalData(),
    'comp-by-ee': useCompByEEReportModalData(),
  };
  ...
  const reportData = allReports[activeReport as keyof typeof allReports];
