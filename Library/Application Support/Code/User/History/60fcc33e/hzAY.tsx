...
const useDownloadPayslip = () => {
  ...
  //   { responseType: 'arraybuffer' }, // TODO: How to fix responseType inside request-sync's useRenderEmployeePayslip?
  // );
  const { mutateAsync } = useRenderEmployeePayslip();
  ...
  return async (
    ...
    // Make the Blob response a URL where to hold the file.
    // The response type from wrapper is incorrect here, ignores the blob-ness
