...
import * as ListComponents from 'designSystem/component/list';
...
jest.mock('designSystem/component/list', () => ({
  ...jest.requireActual('designSystem/component/list'),
  ListItem: jest.fn(({ children, className }) => (
    <div className={className} data-testid="list-item">
      {children}
    </div>
  )),
  ListItemAvatar: jest.fn(({ src, name }) => (
    <div data-testid="list-item-avatar" data-src={src} data-name={name} />
  )),
  ListItemText: jest.fn(({ children, meta, className }) => (
    <div className={className} data-testid="list-item-text" data-meta={meta}>
      {children}
    </div>
  )),
}));

const mockListItem = ListComponents.ListItem as jest.MockedFunction<
  typeof ListComponents.ListItem
>;
const mockListItemAvatar = ListComponents.ListItemAvatar as jest.MockedFunction<
  typeof ListComponents.ListItemAvatar
>;
const mockListItemText = ListComponents.ListItemText as jest.MockedFunction<
  typeof ListComponents.ListItemText
>;
...
describe('Leads', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render ListItem for each lead', () => {
      const mockOrgUnit = createMockOrgUnit({
        orgUnitLeadsList: [
          createMockLead('lead-1', 'John Doe', 'Engineering Manager'),
          createMockLead('lead-2', 'Jane Smith', 'Product Manager'),
      ...
      expect(mockListItem).toHaveBeenCalledWith(
    ...
    it('should render ListItemAvatar with correct props', () => {
      const mockOrgUnit = createMockOrgUnit({
        orgUnitLeadsList: [
          createMockLead('lead-1', 'John Doe', 'Engineering Manager'),
        ],
      ...
      expect(mockListItemAvatar).toHaveBeenCalledWith(
        expect.objectContaining({
          size: 'default',
          src: 'https://example.com/lead-1.jpg',
          name: 'John Doe',
        }),
        expect.anything(),
      );
    ...
    it('should render ListItemText with name and position title', () => {
      const mockOrgUnit = createMockOrgUnit({
        orgUnitLeadsList: [
          createMockLead('lead-1', 'John Doe', 'Engineering Manager'),
        ],
    ...
    it('should render ListItemText without meta when position title is missing', () => {
      const mockOrgUnit = createMockOrgUnit({
