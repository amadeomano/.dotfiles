...
// We're using fr-CA because in this locale the separator is a dash => yyyy-mm-dd
// TODO: refactor to a less hacky approach without having to use fr-CA
...
export const AllocateContributionGroup: FC = () => {
  ...
  const handleSubmit = ({ contributionType, ...rawRequestBody }: FormData) => {
    ...
    if (contributionType && requestBody.employerContributionOverride)
      requestBody.employerContributionOverride.contributionType =
        contributionType;
    if (contributionType && requestBody.employeeContributionOverride)
      requestBody.employeeContributionOverride.contributionType =
        contributionType;
