...
describe('ViewActionsBar', () => {
  ...
  it('should expand all nodes and fit them to screen', () => {
    const sub11 = { id: 'sub-1-1' };
    const sub12 = { id: 'sub-1-2' };
    const sub1 = { id: 'sub-1', children: [sub11, sub12], childrenCount: 2 };
    const sub2 = { id: 'sub-2' };
    const root1 = { id: 'root-1', children: [sub1], childrenCount: 1 };
    const root2 = { id: 'root-2', children: [sub2], childrenCount: 1 };

    const nodes = [root1, root2, sub1, sub2, sub11, sub12];
    const expanded = ['root-1', 'root-2'];
    ...
    expect(setExpandedMock).toHaveBeenCalledWith([
      'root-1',
      'root-2',
      'sub-1',
      'sub-2',
