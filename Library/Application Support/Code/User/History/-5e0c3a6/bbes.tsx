...
import * as orgUnitsModule from '@personio-web/employees-organizations-feature-org-units';
...
const mockSetOrgUnitDetailsState = jest.fn();
jest.spyOn(orgUnitsModule, 'useOrgUnitDetailsState').mockReturnValue({
  state: null,
  setState: mockSetOrgUnitDetailsState,
...
describe('ViewActionsBar', () => {
  ...
  it('renders correctly', () => {
    let onChangeViewportHandler:
      | undefined
      | ((viewport: reactFlow.Viewport) => void);
    useOnViewportChange.mockImplementation(
  ...
  describe('Reset to home view', () => {
    it('should reset active card id, filters, spotlight and expansion state', () => {
      ...
      expect(mockSetOrgUnitDetailsState).toHaveBeenCalledWith(null);
    });
  });
