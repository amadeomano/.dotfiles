...
>) => {
  ...
  console.log('[]', usesPeriodNavigator);
...
const HubHeaderRaw = <T extends 'payroll' | 'payroll-integrations'>({
   ...
   */
  const isPeriodNavigatorActive =
    usesPeriodNavigator === undefined ? true : usesPeriodNavigator;
  ...
  const cloneChildrenWithProps = (child: React.ReactNode): React.ReactNode => {
    ...
    console.log('[] props', { usesPeriodNavigator, isPeriodNavigatorActive });
    return React.cloneElement<any>(child, {
      title,
      usesPeriodNavigator: isPeriodNavigatorActive,
    });
  };

  const childs = children || [
    <HeaderBase title={title} usesPeriodNavigator={isPeriodNavigatorActive} />,
  ];
