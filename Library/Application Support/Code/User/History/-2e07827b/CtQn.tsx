...
describe('useOrgChartDataSourceContext', () => {
  ...
  describe('Additional Relationships', () => {
    ...
    it('should handle additional supervisors correctly', async () => {
      const { result } = renderHookWithProvider({ spotlight: '1' });
      ...
      console.log(
        '[] sup',
        inspect(
          result.current.displayableHierarchy.getNode(
            'dynamic_66c73d69337bb1.80940209-503-supervisor',
          ),
        ),
      );
    });
