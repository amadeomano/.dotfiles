...
import { type OrgChartPreferences, type AdditionalRelationshipType, FilterCondition, NodeType } from '../types';
import {
  initialAttributes,
  ...
  describe('Additional Relationships', () => {
    ...
    it('should handle additional supervisors and subordinates correctly', async () => {
      const { result } = renderHookWithProvider({
        spotlight: '1',
        spotlightVisibleRelationships: [
          'dynamic_66c73d69337bb1.80940209:supervisor',
          'dynamic_66c73d69337bb1.80940209:report',
          'dynamic_66c73d69337bb1.80940210:supervisor',
          'dynamic_66c73d69337bb1.80940210:report',
        ],
      });
      ...
      expect(additionalRels?.filter(rel => rel.type === )).toBeDefined();
      console.log(
        '[] hier',
