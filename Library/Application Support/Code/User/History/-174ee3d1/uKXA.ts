...
const setPermittedActions = (
  ...
  console.log('[]', 'Creatung setter', result);
  return ({ legalEntityResourceActions }: ListPermissionsData) => {
    console.log('[]', 'setting PA', legalEntityResourceActions, result);
...
export const usePermission = (
  ...
  useEffect(() => {
    ...
    mutateAsync({
      ...
      // .then(setPermittedActions(result, legalEntityId))
      .catch(handleError);
  }, [legalEntityId]);
