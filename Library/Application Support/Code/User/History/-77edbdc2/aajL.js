...
async function exampleUsage() {
  ...
  try {
    ...
    console.log('Example configurations created. Replace URLs with actual websites to test.');
  } catch (error) {
