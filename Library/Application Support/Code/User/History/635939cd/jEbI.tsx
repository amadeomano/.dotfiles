 ...
 * 
 * Following data are returned as well to improve composability with other hooks (e.g. useViewportActions)
 * 
 ...
 * - setOnNodeClickHandler: assigns an event listener to the click event of the nodes
 */
