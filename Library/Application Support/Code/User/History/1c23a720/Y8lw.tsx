...
describe('HoverCard', () => {
  ...
  describe('<HoverCard.Person />', () => {
    ...
    it('should display department and team as a link when id is provided', async () => {
      renderPersonHoverCard({
        person: {
          ...mockPerson,
          department: {
      ...
      expect(
        screen.getByRole('link', { name: 'mock-department' }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole('link', { name: 'mock-team' }),
      ).toBeInTheDocument();
    });
  ...
  describe('<HoverCard.Report />', () => {
    ...
    it('should display direct report information', async () => {
      ...
      expect(screen.getByText('27/40h')).toBeInTheDocument();
