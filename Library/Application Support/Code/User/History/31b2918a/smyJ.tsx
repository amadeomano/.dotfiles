...
import { navigateToPayRun } from '../../../hooks/navigators/usePayRunNavigator';
...
export const getTitle = (run: PayrollRun, payGroups: PayGroup[]): string => {
...
const TitleCell: ColConfig['cell'] = ({ value, row }) => <h2>Hi</h2>;
export const titleColumn = (
  ...
  cell: ({ value, row }) => (
    <TableCell.Link
      ...
      onClick={() => navigateToPayRun(router)(row.id)}
    />
  ),
