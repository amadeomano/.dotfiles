...
export type ColConfig = ColumnConfig<PayrollRun, unknown> & {
  ...
  // TODO: remove once GroupBy type of table doesn't return any
  defaultGroupProps?: NonNullable<
    NonNullable<UseTableParams['state']>['groups']
  >[number];
};
