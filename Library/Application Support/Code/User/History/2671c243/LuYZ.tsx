      ...
      <ControlBar
        ...
        setSpotlight={(newSpotlight) => {
          ...
          if (newSpotlight) {
            ...
            setTimeout(() => {
              viewportActions.findAndFocusOnNodeBranch(focusedEmployeeId);
            }, 0);
          } else {
            console.log('[] framing ', dataSource.expansionState.expanded);
            viewportActions.fitNodes(dataSource.expansionState.expanded);
          }
        }}
