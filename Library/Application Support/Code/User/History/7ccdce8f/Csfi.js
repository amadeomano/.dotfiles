...
async function main() {
  ...
  const config = {
    ...
    meanings: {
      ...
      extractHTML: true,
      transform: (meanings) => {
        console.log("Transform called with meanings count:", meanings.length);
        console.log("First meaning type:", typeof meanings[0]);
        console.log(
          "First meaning preview:",
          meanings[0] ? meanings[0].substring(0, 100) : "No meaning"
        );
