...
describe('Members', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render members section when there are members', () => {
      ...
      expect(cardMembers).toHaveTextContent('+24 members'); // "+2" for avatars & "4" for members
    });

    it('should render Facepile with correct props', () => {
      const mockOrgUnit = createMockOrgUnit();
  ...
  describe('Conditional Rendering', () => {
    ...
    it('should not render when member data is null', () => {
      mockUseOrgUnitMemberData.mockReturnValue(
        createMockMemberData({ data: null }) as never,
      );
    ...
    it('should not render when member data is undefined', () => {
      mockUseOrgUnitMemberData.mockReturnValue(
        createMockMemberData({ data: undefined }) as never,
      );
