...
describe('mapEdges', () => {
  ...
  it.skip('should map edges for group nodes', () => {
    const groupNodes = [
      {
        id: 'Group1',
        data: {
  ...
  it('should map edges for group nodes and 1 children node below root', () => {
    const groupNodes = [
      {
        id: 'Group1',
        data: {
    ...
    const mockRootNode = {
      ...rootNode,
      children: [nodeA, nodeB, { ...nodeC, y: 110, group: { id: 'default' } }],
    };
    const treeNodes = [mockRootNode] as unknown as TreeNode<BaseData>[];
    const edges = mapEdges({ treeNodes, groupNodes, layoutOptions });
