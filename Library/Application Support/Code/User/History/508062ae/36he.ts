...
describe('mapEdges', () => {
  ...
  it('should map edges between root and its children', () => {
    ...
    const treeNodes = [mockRootNode] as unknown as TreeNode<
      BaseData & CardProps
    >[];
  ...
  it('should map edges for clustered nodes', () => {
    ...
    clusterNodes.forEach((node, i) => {
      (node as unknown as TreeNode<BaseData & CardProps>)['cluster'] = {
        index: i,
        nodes: clusterNodes as unknown as ClusterTreeNode<
          BaseData & CardProps
        >[],
      };
    });
  ...
  it('should handle a scenario where there are no edges to map', () => {
    const treeNodes = [] as unknown as TreeNode<BaseData & CardProps>[];
    const edges = mapEdges({ treeNodes, layoutOptions });
  ...
  it('should map edges for group nodes', () => {
    ...
    ] as GroupedNode<BaseData & CardProps>[];
    const mockRootNode = { ...rootNode, children: [nodeA, nodeB, nodeC] };
    const treeNodes = [mockRootNode] as unknown as TreeNode<
      BaseData & CardProps
    >[];
