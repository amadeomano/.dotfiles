...
type CardData = BaseData & CardProps;
...
describe('mapEdges', () => {
  ...
  it('should map edges between root and its children', () => {
    ...
    const treeNodes = [mockRootNode] as unknown as TreeNode<CardData>[];
  ...
  it('should map edges for clustered nodes', () => {
    ...
    clusterNodes.forEach((node, i) => {
      (node as unknown as TreeNode<CardData>)['cluster'] = {
        index: i,
        nodes: clusterNodes as unknown as ClusterTreeNode<CardData>[],
      };
    });
  ...
  it('should handle a scenario where there are no edges to map', () => {
    const treeNodes = [] as unknown as TreeNode<CardData>[];
    const edges = mapEdges({ treeNodes, layoutOptions });
  ...
  describe('indicate active edges', () => {
    ...
    it('should render a render an active edge on the side of an active node', () => {
      const mockNodeF = {
        ...nodeF,
        data: { ...nodeF.data, isActive: true },
        children: undefined,
      };
      const clusterNodes = [nodeA, nodeB, nodeC, nodeD, nodeE, mockNodeF];
      clusterNodes.forEach((node, i) => {
        (node as unknown as TreeNode<CardData>)['cluster'] = {
          index: i,
          nodes: clusterNodes as unknown as ClusterTreeNode<CardData>[],
