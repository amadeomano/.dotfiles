...
import { getSchemasFn, payGroups, tabList } from './customBreadcrumbs';
...
export const WithHeaderContnet: StoryObj = {
  args: {
    ...config.args,
    children: [
      <HeaderContent>
        <p style={{ background: 'grey', height: 200 }}>Header Contents</p>
      </HeaderContent>,
      config.args?.children,
    ],
  },
};
export const WithCustomBreadcrumbs: StoryObj = {
  args: {
    legalEntities: payGroups,
    tabs: tabList,
    breadcrumbSchemaFn: getSchemasFn,
  },
};
