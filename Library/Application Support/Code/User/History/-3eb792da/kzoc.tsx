      ...
      >
        <Stack space="gap-large">
          ...
          <Stack space="gap-large" className={styles.popoverContentFooter}>
            <h3>{t('attributes.leads')}</h3>
            <h5 className={styles.subHeader}>
              {t('leads-section.subtitle', { maxAllowedLeads: 3 })}
            </h5>
          </Stack>
        </Stack>
      </Popover.Content>
