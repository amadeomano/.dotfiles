...
describe('ParallelModeStatus', () => {
  ...
  it('should render LocalBanner with correct props for mode PARALLEL and status PARALLEL_ENABLED', () => {
    mockUseParallelMode.mockReturnValue({
      mode: 'PARALLEL',
    ...
    expect(
      screen.getByRole('heading', { name: 'Legal entity in parallel run' }),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
  ...
  it('should render LocalBanner with correct props for mode LIVE and status LIVE_Requested', () => {
    mockUseParallelMode.mockReturnValue({
      mode: 'LIVE',
    ...
    expect(
      screen.getByRole('heading', {
        name: 'Legal entity going live soon',
      }),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
