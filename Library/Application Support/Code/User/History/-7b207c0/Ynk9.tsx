...
import { useParallelMode as fetch } from '../../hooks/useParallelMode';

const mockUseParallelMode = jest.mock('../../hooks/useParallelMode');

describe('ParallelModeStatus', () => {
  const mockUseParallelMode = fetch as jest.MockedFunction<typeof fetch>;
