...
const useEEByCompReport = (): { build: () => ReportTableArgs } => {
  ...
  const { compensationSchemas, isFetching: isCompSchemasLoading } =
    useEmployerCompensationSchemas();
