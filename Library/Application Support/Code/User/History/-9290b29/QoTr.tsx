...
export const PersonCardDataLoaderProvider = ({
  ...
  const { additionalSupervisorAttributesData: additionalAttrs } = useOrgChartDataSourceContext();
  ...
  const personCardDataLoader = useMemo(
    () =>
      getPersonCardDataLoader({
        companyId,
        attributeIds,
        additionalSupervisorAttributeIds.additionalSupervisorAttributeIds,
      }),
