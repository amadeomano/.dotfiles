...
describe('Column Configurations', () => {
  ...
  test('taxPeriodColumn accessor and cell', () => {
    const row = mockPayrollRun;
    const { period } = row;
    ...
    test('getGroups should group data and return the groups correctly', () => {
      ...
      const groupedPayRuns: Grouping[] = [
        { uniqueId: 'unique-id', id: 'g1', label: 'Period', value: 'M2' },
        { uniqueId: 'unique-id', id: 'g1', label: 'Period', value: 'M1' },
      ];
      const groups = statusColumn.getGroups?.(payRunsToGroup, {
        groupId: 'g1',
        filters: [],
  ...
  test('taxYearColumn accessor and cell', () => {
    const row = mockPayrollRun;
    const { taxYear } = row;
