...
describe('tableConfig', () => {
  describe('getBlockersTooltip', () => {
    ...
    it("should render the key without any prefix if there's only a single blocker", () => {
      expect(
        getBlockersTooltip(
          [{ attributeName: 'ABC', attributeValue: 'abc', message: 'msg' }],
          t,
        ),
      ).toBe('xero.hub.people-table.msg');
    });

    it('should concatenate the keys and prefix them with their count', () => {
      expect(
        getBlockersTooltip(
          [
            { attributeName: 'ABC', attributeValue: 'abc', message: 'msg' },
      ...
      ).toBe('2: xero.hub.people-table.msg, xero.hub.people-table.gsm');
    });
  });
  ...
  describe('columnConfig', () => {
    ...
    describe('blockers column', () => {
      ...
      it('should render the blockers using a Enum TableCell when any blocker exists', () => {
        ...
        const tooltip = getBlockersTooltip(blockersList);
        expect(
          blockers.cell({
            row: data[0],
            value: blockersList,
          ...
          <TableCell.Enum
            ...
            tooltip={{
              content: (
                <ul>
                  <li>xero.hub.people-table.cde</li>
                </ul>
              ),
            }}
