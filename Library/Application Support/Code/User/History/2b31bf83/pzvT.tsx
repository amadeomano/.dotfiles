...
describe('tableConfig', () => {
  describe('getBlockersTooltip', () => {
    ...
    it('should render a single blocker without a list', () => {
    ...
    it('should render a list of blockers', () => {
      ...
      expect(listItems[0]).toHaveTextContent('xero.hub.people-table.msg');
      expect(listItems[1]).toHaveTextContent('xero.hub.people-table.gsm');
    });
  });
