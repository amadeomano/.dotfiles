...
3. Add the feature flag to your local `split.js` [file](https://gitlab.personio-internal.de/personio/frontend/personio-web/-/blob/main/split.js#L19) (or enable it on split.io)
```
const flags = {
