...
type ContributionType = CreatePensionContributionGroupBody['employerContribution'] | CreatePensionContributionGroupBody['employeeContribution'];
const ContributionValue = (contributionType: ContributionType, value: string) =>
