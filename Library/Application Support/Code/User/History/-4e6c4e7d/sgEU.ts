...
describe('exportNodes', () => {
  ...
  it('should export nodes as JPEG', async () => {
    ...
    await exportNodes({ format: ExportFormat.JPEG, nodes: mockNodes, t });
  ...
  it('should export nodes as SVG', async () => {
    ...
    await exportNodes({ format: ExportFormat.SVG, nodes: mockNodes, t });
  ...
  it('should export nodes as PDF', async () => {
    ...
    await exportNodes({ format: ExportFormat.PDF, nodes: mockNodes, t });
