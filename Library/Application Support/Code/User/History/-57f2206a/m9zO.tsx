  ...
  return (
    <FormProvider {...form}>
      <PropertyList>
        ...
        <PropertyListItem>
          <PropertyListItemLabel>
            Contribution type {overrideContribution ? 'Override' : ''}
          </PropertyListItemLabel>
          <PropertyListItemValue.Enum
            {...(overrideContribution
              ...
              : {
                  value:
                    pension.pensionContributionGroup.employeeContribution
                      .contributionType,
                })}
          />
        </PropertyListItem>
        <PropertyListItem>
          <PropertyListItemLabel>
            Employer Contribution {overrideContribution ? 'Override' : ''}
          </PropertyListItemLabel>
          {(overrideContribution && contributionType === 'PERCENTAGE') ||
          (!overrideContribution &&
            pension.pensionContributionGroup.employerContribution
