...
import type { PayrollLayoutComponent, Action as PayrollAction } from './types';
...
export const PayrollLayout: PayrollLayoutComponent = ({
  ...
  const { isVisible = true } = primaryAction ?? ({} as PayrollAction);
  const hasPrimaryAction = primaryAction && isVisible;
