...
import { useTabbarLocation } from './components/tabBarLocation';
...
export const PayrollLayout: PayrollLayoutComponent = ({
  ...
  const { tabBarLocation, setTabbarLocation } = useTabbarLocation();
  ...
  return (
    ...
    >
      ...
      <PageHierarchical.LayoutFullWidth title={title}>
        ...
        {slots.header}
        {tabs && <TabBar {...tabs} onMount={setTabbarLocation} />}
        {rest}
