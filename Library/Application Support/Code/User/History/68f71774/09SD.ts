...
describe('deserializeSort', () => {
  it('should return undefined if no serialized string is provided', () => {
    const result = deserializeSort(undefined);
...
describe('deserializeFilter', () => {
  it('should return undefined if no serialized string is provided', () => {
    const result = deserializeFilter(undefined);
    expect(result).toBeUndefined();
  });
...
describe('deserializeArrayFilter', () => {
  it('should return undefined if no serialized string is provided', () => {
    const result = deserializeArrayFilter(undefined);
    expect(result).toBeUndefined();
  });
