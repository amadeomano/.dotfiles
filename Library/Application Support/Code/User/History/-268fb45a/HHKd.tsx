...
export const CreateContributionGroup = () => {
  ...
  const [contributionSuffix, setContributionSuffix] = useState('');
  ...
  const handleContributionTypeChange = (value: string) =>
    setContributionSuffix(value === 'PERCENTAGE' ? '%' : '€');
  console.log('Contribution suffix has changed', contributionSuffix);
  ...
  const handleSubmit = ({ contributionType, ...rawRequestBody }: FormData) => {
    ...
    requestBody.employerContribution.contributionType = contributionType;
    requestBody.employeeContribution.contributionType = contributionType;
      ...
      <Sidepanel.Content>
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)}>
            ...
            />
            <ControlledSelect<FormData> name="earningsType">
            ...
            />
            <ControlledSelect<FormData> name="taxationMethod">
              <Select.TriggerValue placeholder="Select an earning type" />
              <Select.Viewport>
