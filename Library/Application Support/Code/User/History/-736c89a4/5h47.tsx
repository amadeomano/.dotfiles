...
import { OrgChartDataSourceContext } from '../../../hooks';
...
type DataSource = Partial<ContextType<typeof OrgChartDataSourceContext>>;
const Wrapper = (props?: Partial<ControlBaSpotlightProps> & DataSource) => {
  ...
  const dataSource: DataSource = {
    activeNodesState: {
      activeNodeIds: props?.activeNodesState?.activeNodeIds ?? [],
      setActiveNodeIds: jest.fn(),
    },
  };

  return (
    <OrgChartDataSourceContext.Provider value={dataSource}>
      <ControlBarSpotlight
        focusedEmployeeId=""
        spotlight={spotlight}
