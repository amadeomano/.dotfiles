...
// import { listPayGroupsHandlers } from '@personio-web/payroll-data-payroll-me/src/handlers';
// (window as any).worker = setupWorker(listPayGroupsHandlers.defaultHandler);
// (window as any).worker.start();
