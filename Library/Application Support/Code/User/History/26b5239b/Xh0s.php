    ...
    Route::group(['middleware' => ['prevent-xss']], function () {
        ...
        Route::group([
            ...
            Route::group([
                ...
                /* TODO: Remove once PREPAY-113-preliminary-payroll-on-O11 is fully rolled out */
                ...
                /* END-TODO: Remove once PREPAY-113-preliminary-payroll-on-O11 is fully rolled out */
