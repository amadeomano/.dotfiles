    ...
    Route::group(['middleware' => ['prevent-xss']], function () {
        ...
        Route::group([
            ...
            Route::group([
                ...
                $baseRoute = Route::get('payroll/{subroute?}', function () {
                    return 'This route is working';
                })
                    ->where('subroute', '^(?!overview|verification|personal).*')
                    ->name('payroll.landing')->middleware('frontend-orchestrator');
                ...
                $personalRoute = Route::get('payroll/personal', MicroFrontendController::class)
                    ->name('payroll.personal')->middleware('frontend-orchestrator');
                $salaryRoute = Route::get('payroll/salary', 'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@index')
                    ->name('payroll.salary')->middleware('frontend-orchestrator');
                $absenceRoute = Route::get('payroll/absence', 'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@index')
                    ->name('payroll.absence')->middleware('frontend-orchestrator');
                $employeeChangesRoute = Route::get(
                    'payroll/employee-changes',
                    'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@index',
                )->name('payroll.employee-changes')->middleware('frontend-orchestrator');
                $documentsRoute = Route::get(
                    'payroll/documents',
                    'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@index',
                )->name('payroll.documents')->middleware('frontend-orchestrator');
                ...
                // ];
                $personalRoute->defaults = [
                    'frontend' => 'payroll',
                    'mountId' => 'payroll-view-preliminary-payroll',
                    'pageTitle' => 'Payroll',
                    'featureFlag' => 'PREPAY-113-preliminary-payroll-on-O11',
                ];
                $salaryRoute->defaults = [
                    'frontend' => 'payroll',
                    'mountId' => 'payroll-view-preliminary-payroll',
                    'pageTitle' => 'Payroll',
                    'featureFlag' => 'PREPAY-113-preliminary-payroll-on-O11',
                ];
                $absenceRoute->defaults = [
                    'frontend' => 'payroll',
                    'mountId' => 'payroll-view-preliminary-payroll',
                    'pageTitle' => 'Payroll',
                    'featureFlag' => 'PREPAY-113-preliminary-payroll-on-O11',
                ];
                $employeeChangesRoute->defaults = [
                    'frontend' => 'payroll',
                    'mountId' => 'payroll-view-preliminary-payroll',
                    'pageTitle' => 'Payroll',
                    'featureFlag' => 'PREPAY-113-preliminary-payroll-on-O11',
                ];
                $documentsRoute->defaults = [
                    'frontend' => 'payroll',
                    'mountId' => 'payroll-view-preliminary-payroll',
                    'pageTitle' => 'Payroll',
                    'featureFlag' => 'PREPAY-113-preliminary-payroll-on-O11',
