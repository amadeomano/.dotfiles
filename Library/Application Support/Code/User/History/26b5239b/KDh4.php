    ...
    Route::group(['middleware' => ['prevent-xss']], function () {
        ...
        Route::group([
            ...
            Route::group([
                ...
                Route::get('payroll', 'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@index')
                ...
                $baseRoute = Route::get('payroll/{subroute?}', MicroFrontendController::class)
                    ...
                    ->name('payroll.base')->middleware([
                        \Personio\HRM\Payroll\PreliminaryPayroll\Http\Middleware\PersonioPayrollAccessCheckMiddleware::class,
                        'frontend-orchestrator:skipFeatureFlags'
                    ]);
