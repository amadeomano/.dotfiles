    ...
    Route::group(['middleware' => ['prevent-xss']], function () {
        ...
        Route::group([
            ...
            Route::group([
                ...
                Route::get('payroll/overview', 'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@legacy')
                    ->name('payroll.overview');
                Route::get('payroll/verification', 'Personio\HRM\Payroll\PreliminaryPayroll\Http\Controllers\PreliminaryPayrollViewController@legacy')
                ...
                $baseRoute = Route::get('payroll/{subroute?}', MicroFrontendController::class);
                    ...
                    // ->name('payroll.base')->middleware('frontend-orchestrator:skipFeatureFlags');
