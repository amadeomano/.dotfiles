...
import { URL_PARAM_LEGAL_ENTITY, useGbNavigation } from '../../hooks/usePayrollGbBreadcrumbsNavigation';
import { useRouter } from 'next/router';

const PAYGROUP_ID = '8046237e-1452-4296-9a5a-ad6d89997880';
...
export const DevelopmentHelperTab = () => {
  ...
  const { allGroups: groups, group: payGroup, refetch: refetchGroups } =
    useCurrentPayrollGroup();

  const groupPayPeriod = payGroup?.payPeriods.find(
    (p) => p.periodNumber === Number(groupId),
  );
  ...
  const createRun = () => {
    const params = {
      payGroupId: PAYGROUP_ID, // TODO: from context
      payDate: payGroup?.payPeriods., // TODO: from group currentPeriod -> payDate
    };
