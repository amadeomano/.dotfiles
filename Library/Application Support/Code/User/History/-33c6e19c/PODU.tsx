...
describe('OrgUnitsView', () => {
  ...
  it.skip('should navigate to details when org unit is successfully edited', async () => {
    mockRouter.push('/organization/org-units/departments/edit/1');
    renderWithWrapper(<OrgUnits />);

    expect(OrgUnitsEdit).toHaveBeenCalled();
  ...
  it.skip('should navigate back to edit when confirmation is cancelled', async () => {
