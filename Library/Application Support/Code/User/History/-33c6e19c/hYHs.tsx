...
describe('OrgUnitsView', () => {
  ...
  it('should navigate back when Close button is clicked in error state', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/We ran into a problem/i)).toBeInTheDocument();
    });

    // Find the close button within the drawer/dialog
