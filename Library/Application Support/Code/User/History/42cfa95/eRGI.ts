...
export type ListEmployerPensionSchemes = (
  options: { headers: ListEmployerPensionSchemesHeaders } & AxiosRequestConfig,
...
export type ListFilings = (
  options: { headers: ListFilingsHeaders } & AxiosRequestConfig,
...
export type ListPayGroups = (
  options: { headers: ListPayGroupsHeaders } & AxiosRequestConfig,
...
export type ListCompensationTypes = (
  options: { headers: ListCompensationTypesHeaders } & AxiosRequestConfig,
...
export type CreateEmployerCompensationSchema = (
  ...
  } & Omit<AxiosRequestConfig<CreateEmployerCompensationSchemaBody>, 'headers'>,
