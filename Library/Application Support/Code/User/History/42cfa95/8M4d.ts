...
export type GetEmployeeAutoEnrolmentConfiguration = (
  options: {
...
export type UpdatePendingAutoenrolmentAction = (
  options: {
  ...
  } & Omit<AxiosRequestConfig, 'data' | 'headers'>,
...
export type UpdateEmployeeAutoEnrolmentHistoricalAssessment = (
  options: {
...
export type RenderEmployeePayslip = (
  options: {
...
export type ListEmployeePensions = (
  options: {
...
export type CreateEmployeePension = (
  options: {
...
export type GetEmployeePension = (
  options: {
...
export type UpdateEmployeePension = (
  options: {
...
export type DeleteEmployeePension = (
  options: {
...
export type ListEmployerPensionSchemes = (
  options: { headers: ListEmployerPensionSchemesHeaders } & Omit<
    AxiosRequestConfig,
    'headers'
  >,
...
export type CreateEmployerPensionScheme = (
  options: {
...
export type GetEmployerPensionScheme = (
  options: {
...
export type UpdateEmployerPensionScheme = (
  options: {
...
export type DeleteEmployerPensionScheme = (
  options: {
...
export type ListPensionContributionGroups = (
  options: {
...
export type CreatePensionContributionGroup = (
  options: {
...
export type GetPensionContributionGroup = (
  options: {
...
export type UpdatePensionContributionGroup = (
  options: {
...
export type DeletePensionContributionGroup = (
  options: {
...
export type UpdateEmployerAutoEnrolment = (
  options: {
...
export type GetEmployerAutoEnrolment = (
  options: {
...
export type ListFilings = (
  options: { headers: ListFilingsHeaders } & Omit<
    AxiosRequestConfig,
    'headers'
  >,
...
export type FetchLegalEntityData = (
  options: {
...
export type ListPayGroups = (
  options: { headers: ListPayGroupsHeaders } & Omit<
    AxiosRequestConfig,
    'headers'
  >,
...
export type CreatePayGroup = (
  options: { data: CreatePayGroupBody; headers: CreatePayGroupHeaders } & Omit<
    AxiosRequestConfig,
    'data' | 'headers'
  >,
...
export type UseCreatePayGroupOptions = import('react-query').UseMutationOptions<
  ...
  {
    requestBody: CreatePayGroupBody;
    requestHeaders: CreatePayGroupHeaders;
  } & Omit<AxiosRequestConfig, 'data' | 'headers'>
>;
...
export type RetrievePayrollRun = (
  options: {
...
export type PreviewPayrollRunFPS = (
  options: {
...
export type RetrieveBacsFileForPayrollRun = (
  options: {
...
export type ListPayrollRuns = (
  options: {
    params: ListPayrollRunsQuery;
    headers: ListPayrollRunsHeaders;
  } & Omit<AxiosRequestConfig, 'params' | 'headers'>,
...
export type UseListPayrollRuns = <Selection = ListPayrollRunsData>(
  options: {
    axiosOptions: Omit<AxiosRequestConfig, 'params' | 'headers'>;
  } & UseListPayrollRunsOptions<Selection>,
) => import('react-query').UseQueryResult<
  Selection,
  AxiosError<ListPayrollRunsErrorResponse>
>;
...
export type ListCompensationTypes = (
  options: { headers: ListCompensationTypesHeaders } & Omit<
    AxiosRequestConfig,
    'headers'
  >,
...
export type CreateDefaultSchemas = (
  options: {
...
export type ListEmployerCompensationSchemas = (
  options: {
...
export type CreateEmployerCompensationSchemaPathParams = never;

export type HandlerCreateEmployerCompensationSchemaPathParams =
  NormalizeParams<CreateEmployerCompensationSchemaPathParams>;

export type CreateEmployerCompensationSchemaQuery = never;

export type CreateEmployerCompensationSchemaHeaders =
  import('./schema.ts').operations['createEmployerCompensationSchema']['parameters']['header'];

export type CreateEmployerCompensationSchemaBody = NonNullable<
  import('./schema.ts').operations['createEmployerCompensationSchema']['requestBody']
>['content']['application/json'];

export type CreateEmployerCompensationSchemaData201 =
  import('./schema.ts').operations['createEmployerCompensationSchema']['responses'][201]['content']['application/json'];

export type CreateEmployerCompensationSchemaErrorResponse400 =
  import('./schema.ts').operations['createEmployerCompensationSchema']['responses'][400]['content']['application/json'];

export type CreateEmployerCompensationSchemaErrorResponse409 =
  import('./schema.ts').operations['createEmployerCompensationSchema']['responses'][409]['content']['application/json'];

export type CreateEmployerCompensationSchemaData =
  CreateEmployerCompensationSchemaData201;

export type CreateEmployerCompensationSchemaDataResponse = {
  data: CreateEmployerCompensationSchemaData;
};

export type CreateEmployerCompensationSchemaErrorResponse =
  | CreateEmployerCompensationSchemaErrorResponse400
  | CreateEmployerCompensationSchemaErrorResponse409;

export type CreateEmployerCompensationSchemaAPI = {
  API_PATH: '/public/athena/v1/payrollme/schema/employer-compensation-schema';
  METHOD: 'POST';
  KEY: {
    service: 'International Personio Payroll';
    operationId: 'createEmployerCompensationSchema';
  };
};

export type CreateEmployerCompensationSchema = (
  options: {
    data: CreateEmployerCompensationSchemaBody;
    headers: CreateEmployerCompensationSchemaHeaders;
  } & Omit<AxiosRequestConfig, 'data' | 'headers'>,
) => Promise<CreateEmployerCompensationSchemaData>;

export type UseCreateEmployerCompensationSchemaKey = [
  CreateEmployerCompensationSchemaAPI['KEY'],
];

export type UseCreateEmployerCompensationSchemaOptions =
  import('react-query').UseMutationOptions<
    CreateEmployerCompensationSchemaData,
    AxiosError<CreateEmployerCompensationSchemaErrorResponse>,
    {
      requestBody: CreateEmployerCompensationSchemaBody;
      requestHeaders: CreateEmployerCompensationSchemaHeaders;
    } & Omit<AxiosRequestConfig, 'data' | 'headers'>
  >;

export type UseCreateEmployerCompensationSchema = (
  options?: UseCreateEmployerCompensationSchemaOptions,
) => import('react-query').UseMutationResult<
  CreateEmployerCompensationSchemaData,
  AxiosError<CreateEmployerCompensationSchemaErrorResponse>,
  {
...
export type ListSchemaMappings = (
  options: {
...
export type SaveSchemaMappings = (
  options: {
...
export type ListSystemCompensationSchemas = (
  options: { headers: ListSystemCompensationSchemasHeaders } & Omit<
    AxiosRequestConfig,
    'headers'
  >,
...
export type CreateUKCourtOrder = (
  options: {
...
export type UpdateUKCourtOrder = (
  options: {
...
export type ListUKCourtOrderDeductions = (
  options: {
...
export type UpdateUKCourtOrderDeduction = (
  options: {
