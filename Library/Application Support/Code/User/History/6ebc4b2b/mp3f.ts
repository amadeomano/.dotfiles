...
const getValue = (item: HierarchicalOrgUnitGofer): String => item.data.departmentId?.__typename === 'protocore_hrdepartmentid_DepartmentId_v1' ? item.data.departmentId.id : item.data.teamId?.__typename === 'protocore_hrteamid_TeamId_v1' ? item.data.teamId.id : undefined;
