...
import {
  ...
  buildPeopleListExtendedLink,
} from '@personio-web/employees-organizations-hook-generate-people-list-link';
...
export const EmployeeListLink = ({
  ...
  const href = useMemo(() => {
    ...
    const filters: PeopleListExtendedLinkInfoProps['columns'] = [
      {
        id: attributeId,
