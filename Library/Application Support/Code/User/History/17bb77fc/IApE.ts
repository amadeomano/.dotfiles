...
import { type TabDef } from '../../components/temp-layout/Pickers/TabPickerBar';
...
type TabExtended = TabDef & { component: FC };
const tabs: { [K in string]: TabExtended } = {
  payruns: {
    route: 'payruns',
...
export const tabsDefinition: TabDef[] = Object.values(tabs);
