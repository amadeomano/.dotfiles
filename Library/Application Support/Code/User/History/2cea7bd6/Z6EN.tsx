...
describe('EmployeeCompensations', () => {
  ...
  it('renders contributions section correctly', () => {
    ...
    expect(
      screen.getByRole('listitem', { name: 'Total contributions 350' }),
    ).toBeInTheDocument();
  });
  ...
  it('navigates to employee salary on payment item click', () => {
    ...
    userEvent.click(screen.getByRole('listitem', { name: 'Base Salary 2000' }));
  ...
  it('navigates to employee salary on deduction item click', () => {
    ...
    userEvent.click(screen.getByRole('listitem', { name: 'Tax 300' }));
  ...
  it('navigates to employee salary on contribution item click', () => {
    ...
    userEvent.click(screen.getByRole('listitem', { name: 'Pension 200' }));
    expect(mockRouter.asPath).toBe(
