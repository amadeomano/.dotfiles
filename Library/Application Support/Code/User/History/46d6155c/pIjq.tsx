...
import { type TFunction, type ParseKeys } from 'i18next';
...
type SourceOption = {
  label: ParseKeys<'employees-organizations'>['org-chart'];
...
const sourceOptions: Record<Source, SourceOption> = {
  Supervisor: {
    label:
      'employees-organizations.org-chart.control-bar.source-switcher.people',
    icon: icons.people2,
  },
  Department: {
