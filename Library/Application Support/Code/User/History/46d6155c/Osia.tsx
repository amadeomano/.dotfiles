...
import { type TFunction, type ParseKeys, type TOptions } from 'i18next';
...
export const SourceSwitcher = () => {
  ...
  return (
    <Controls.Primary
      label={t(sourceOptions[prefs.source]?.label)}
      icon={null as never}
      className={styles.trigger}
      metadata={{ testId: SOURCE_SWITCHER_TEST_ID }}
    >
      <DropdownMenu.SubTitle>{t('subtitle')}</DropdownMenu.SubTitle>
