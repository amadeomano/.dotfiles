...
const getCustomisations = (
  ...
  description: {
    label: toTranslate.orgUnitCard.customisation.description,
    icon: icons.infoCircle,
  },
  layer: {
    label: toTranslate.orgUnitCard.customisation.layer,
    icon: icons.stairs,
    disabled: true,
  },
  abbreviation: {
    label: toTranslate.orgUnitCard.customisation.code,
    icon: icons.poundSign,
  },
  leads: {
    label: toTranslate.orgUnitCard.customisation.leads,
    icon: icons.person,
    disabled: !isLeadsEnabled,
  },
  totalMembers: {
    label: toTranslate.orgUnitCard.customisation.totalMembers,
    icon: icons.people2,
  },
  openPositions: {
    label: toTranslate.orgUnitCard.customisation.openPositions,
            ...
            >
              <Inline space="gap-default" alignVertical="center">
                <Icon
                  ...
                  color="secondary"
                />
                <span>{t('', { defaultValue: customisation.label })}</span>
              </Inline>
              <Switch
                label=""
                size="small"
