...
describe('Members', () => {
  ...
  beforeEach(() => {
    ...
    // Default mock setup - tests can override as needed
    mockUseOrgUnitFirstMemberIds.mockReturnValue(
      createMockFirstMemberIds(4) as never,
    );
  ...
  describe('Basic Rendering', () => {
    ...
    it('should render Facepile with actual count when directMemberCount <= MAX_VISIBLE_AVATARS', async () => {
      ...
      mockUseOrgUnitFirstMemberIds.mockReturnValue(
        createMockFirstMemberIds(2) as never,
      );
    ...
    it('should render member count text', async () => {
      ...
      mockUseOrgUnitFirstMemberIds.mockReturnValue(
        createMockFirstMemberIds(5) as never,
      );
