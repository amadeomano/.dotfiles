...
export const handleTableStateChange =
  ...
  ({ sorting: sortingState, filters: filtersState }) => {
    ...
    if (employeeNumberFilter) {
      ...
      setTableParam(newUrl, 'employeeNumber', serializedEmployeeNumber);
    ...
    if (grossPayFilter) {
      const serializedGrossPay = serializeFilter(grossPayFilter);
      setTableParam(newUrl, 'grossPay', serializedGrossPay);
