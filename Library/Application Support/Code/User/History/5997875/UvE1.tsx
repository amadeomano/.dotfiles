...
import { FilterConfig, Table, useTable, UseTableParams } from 'designSystem/component/table';
...
export const handleFilterStateChange = (router: NextRouter, tableUrlParams: ReturnType<typeof getTableParams>): UseTableParams['onTableStateChange'] => ({ sorting: sortingState, filters: filtersState }) => {
