...
describe('OrgUnitsSelect', () => {
  ...
  describe('browser specific', () => {
    ...
    it.each([
      ['default', 'Chrome/135.0.0.0 Safari/537.36', undefined],
      ['Safari', 'Safari/537.36', false],
      ['Firefox', 'Firefox/137.0', false],
    ])('%#0 should set autoFocus to %#2', async (_, __, autoFocus) => {
      renderWithWrapper(
        <OrgUnitsSelect
          selectedOptionIds={[]}
          type="department"
    ...
    // it('should not avoid multiselect from auto focus by default', async () => {
    //   renderWithWrapper(
    //     <OrgUnitsSelect
    //       selectedOptionIds={[]}
    //       type="department"
