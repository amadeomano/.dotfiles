...
import { PayGroupItem } from './PayGroupItem';
import styles from './styles.module.scss';
import {
  useListAssignablePayGroups,
  getGroupById,
} from './useListAssignablePayGroups';
import { useAssignToPayGroup } from './useAssignToPayGroup';
...
export const AssignPayrollGroupDialog = ({
  ...
  const { assignToPayGroup, isAssigning } = useAssignToPayGroup();
  const [selectedGroupId, setSelectedGroupId] = useState<string | undefined>(
    undefined,
  );
  const assignableGroups = useListAssignablePayGroups();
        ...
        <ActionBar>
          ...
          <Actions.Primary
            ...
            onClick={() => {
              ...
              assignToPayGroup(selectedGroupId, employeeIds, onClose);
            }}
            type="submit"
          >
            Confirm
