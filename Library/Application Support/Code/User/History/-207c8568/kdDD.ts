export const toTranslate = {
  ...
  orgChart: {
    ...
    tooltip: {
      hiddenDepartments:
        '{{count}} departments are hidden for not having direct members or sub-departments with direct members',
      hiddenTeams:
        '{{count}} teams are hidden for not having direct members or sub-teams with direct members',
    },
  },
};
