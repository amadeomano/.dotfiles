...
import {
  createEmployerPensionSchemeAPI as createEmployerPensionSchemeAPI,
  createEmployerPensionScheme1API as listEmployerPensionSchemeAPI,
...
export const CreatePensionScheme = () => {
  ...
  const handleSuccess = () => {
    queryClient.invalidateQueries({
      queryKey: [listEmployerPensionSchemeAPI.KEY],
    });
