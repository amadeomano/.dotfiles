...
export const useTableConfig = (data?: PayrollRun[]) => {
  const table = useTable({
    state: {
      // TODO: uncomment once table fixes the bug with default group on async data
      // groups: [
      //   columns.taxYearColumn.defaultGroupProps as GroupBy,
      //   columns.taxPeriodColumn.defaultGroupProps as GroupBy,
      // ],
    },
  });
