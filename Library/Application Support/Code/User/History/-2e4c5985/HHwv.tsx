...
export const useFPSPreviewDocumentRow = (): DocumentRow => {
...
export const FPSPreviewModal = () => {
  ...
  return (
    <Dialog.Promo open={true} onOpenChange={closeModal}>
      <Dialog.NavigationBar title="FPS Submission Preview"></Dialog.NavigationBar>
      <Dialog.Content>
        {xmlBody ? (
          <XMLPrettyPreview xml={xmlBody} />
        ) : (
          <Skeleton repeat={20} />
        )}
      </Dialog.Content>
