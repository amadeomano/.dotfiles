...
export const CustomAccessRightsTab = ({
  ...
  console.log(
    ...
    attributeOptions.find(({ value }) => value === 'vacation_day_balance'),
  );
  console.log(
    '[] CustomAccessRightsTab State',
    state.allowedEmployeeAttributes.find(
      ({ value }) => value === 'vacation_day_balance',
    ),
  );
  console.log('[] CustomAccessRightsTab auth', auth);
