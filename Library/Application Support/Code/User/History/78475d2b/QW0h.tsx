...
import { type EntityNode } from '@personio-web/employees-organizations-feature-org-chart-types';
...
type SpanOfControlProps = { node?: Node; type?: OrgUnitType };
  ...
  return (
        ...
        <Trans
          ...
          i18nKey={
            type === 'ORG_UNIT_TYPE_DEPARTMENT'
              ? 'tooltips.subordinates_department'
              : 'tooltips.subordinates_team'
          }
          values={{
    ...
    >
      <p
        ...
        aria-label={tAccessible('subordinates', {
      ...
      >
        ...
        {totalSubordinates > 0 &&
          totalSubordinates !== directSubordinates &&
          ` (${totalSubordinates})`}
      </p>
    </Tooltip>
  );
