...
describe('SavedViewsMenu', () => {
  ...
  it('renders source options menu items', () => {
    ...
    expect(
      screen.getByText(toTranslate.orgChart.controlBar.sourceSwitcher.people),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        toTranslate.orgChart.controlBar.sourceSwitcher.departments,
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByText(toTranslate.orgChart.controlBar.sourceSwitcher.teams),
    ).toBeInTheDocument();
  });
