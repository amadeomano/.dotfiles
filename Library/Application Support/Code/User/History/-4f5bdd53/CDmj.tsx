...
export const handleTableStateChange =
  ...
  ({ sorting: sortingState, filters: filtersState }) => {
    ...
    const employeeCodeFilter = findFilter('employeeCode', filtersState);
    if (employeeCodeFilter) {
      const serializedEmployeeCode = serializeFilter(employeeCodeFilter);
      setTableParam(newUrl, 'employeeCode', serializedEmployeeCode);
  ...
  const table = useTable({
    state: {
      ...
      filters: [
        ...
        deserializeFilter(tableUrlParams.employeeCode),
        deserializeFilter(tableUrlParams.blockers),
        deserializeFilter(tableUrlParams.office),
