...
import { useEmployerPensionSchemes } from './useEmployerPensionSchemes';
import { CreatePensionScheme } from './CreatePensionScheme';
import { usePensionSchemeNavigation } from './usePensionSchemeNavigation';
import { ListContributionGroups } from '../PensionSchemeContributionGroupsSettings/ListContributionGroups';
...
export const ListPensionSchemas = () => {
  ...
  return (
    ...
    >
      ...
      {isInContributionGroupsListRoute ? <ListContributionGroups /> : null}
