...
import { useNavigateToCreatePensionScheme } from './useCreatePensionSchemeNavigation';

export const ListPensionSchemas = () => {
  const { navigateToCreate, isInCreateRoute } =
    useNavigateToCreatePensionScheme();
    ...
    <>
      ...
      <List>
        {pensionSchemes?.data.map((scheme) => (
          <ListItem active onClick={() => console.log}>
            <ListItemText
