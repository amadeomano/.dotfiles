...
type Gender = NonNullable<
  NonNullable<NonNullable<EmploymentDataFragment['person']>['gender']>['value']
>;
...
type EmploymentStatus = NonNullable<
  NonNullable<EmploymentDataFragment['status']>['value']
>;
...
type EmploymentType = NonNullable<
  NonNullable<EmploymentDataFragment['type']>['value']
>;
...
type TerminationType = NonNullable<
  NonNullable<
    NonNullable<EmploymentDataFragment['termination']>['value']
  >['type']
>;
...
type EmploymentDataFragment = NonNullable<
