# General {
	...
	export TMUX_POWERLINE_THEME="amadeo"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/0m/b7hqrwqs3cj4lw6s2d3yb71r0000gq/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/amadeo.manouchehri/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/amadeo.manouchehri/.mailcheckrc"
# }
